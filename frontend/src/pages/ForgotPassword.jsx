        ...
        <div className="mobile-padding-sm" style={{
            ...
            <div className="animate-fade-in mobile-padding-sm" style={{
                ...
                {step === 1 ? (
                    <form onSubmit={handleRequestOTP} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <button
                            ...
                            style={{
                                padding: '1.2rem',
                                borderRadius: '16px',
                                background: loading ? '#222' : 'var(--primary-gradient)',
                    ...
                    <form onSubmit={handleResetPassword} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                        ...
                        <div style={{ marginTop: '1rem', fontSize: '0.9rem', color: '#888' }}>
                            {countdown > 0 ? (
                                <span>Resend code in <strong style={{ color: 'var(--primary-color)' }}>{countdown}s</strong></span>
                            ) : (
                                <button
                                    type="button"
                ...
                <div style={{ marginTop: '2.5rem' }}>
                    <Link to="/login" style={{ color: 'var(--primary-color)', textDecoration: 'none', fontWeight: '700', fontSize: '0.9rem' }}>
                        Back to Sign In
                    </Link>
                </div>
            </div>
