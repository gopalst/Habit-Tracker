    ...
    return (
        <footer style={{
            ...
            <div style={{
                height: '1px',
                width: '100%',
                background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.05), var(--primary-color), rgba(255,255,255,0.05), transparent)',
                marginBottom: '3rem',
                opacity: 0.5
            }}></div>
            <div className="mobile-stack" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                    ...
                    />
                    <SocialIcon
                        href="https://github.com/gopalst"
                        hoverColor="#fff"
                        icon={<GitHubIcon />}
                    />
                    <SocialIcon
                        href="https://www.linkedin.com/in/gopal-tippagol-641352292/"
                        hoverColor="#0077B5"
                        icon={<LinkedInIcon />}
                    />
                </div>
